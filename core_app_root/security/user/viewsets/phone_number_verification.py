...
from rest_framework.viewsets import ModelViewSet
from core_app_root.security.user.serializers.phone_number_verification import PhoneNumberModelSerializer,OTPVerificationSerializer
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            if serializer.is_valid():
                ...
                PhoneNumbersModel.objects.create(user=request.user,code=code,phone=str(serializer.validated_data['phone']))
